...
const Topbar = () => {
  return (
    <div className="w-full bg-cyan-700 text-white text-xs sm:text-sm px-2 py-1 flex justify-between items-center font-sans whitespace-nowrap mx-auto overflow-hidden">
      ...
      <div className="flex items-center gap-3 pl-4 border-l border-white ml-3">
        <a href="#" className="flex items-center gap-1 font-semibold hover:underline">
